...
Because of its modest size and static nature, partitioning is unnecessary. It is sufficient to store this table in a transactional database <span style="color:red;font-weight:bold;">-- ??? why not in no-sql database considering this will not be part of any transaction flow.</span>

<span style="color:red;font-weight:bold;">Future Scope</span>
