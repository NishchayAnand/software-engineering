...
reservation.setRequestId(req.getRequestId());
reservation.setHotelId(req.getHotelId());
reservation.setRoomTypeId(req.getRoomTypeId());
...
reservation.setPriceSnapshot(snapshot);
```
