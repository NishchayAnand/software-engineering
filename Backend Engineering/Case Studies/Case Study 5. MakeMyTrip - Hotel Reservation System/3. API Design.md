...
The `reservationId` is used as the idempotency key to prevent double booking. <span style="color:red;">(explore this more)</span>
##### <span style="color:green;">Response Body (Sample)</span>

```
{
	"hotelId": "101",
	"roomId": [..., "RoomType#RoomType"],
	"checkInDate": "2025-09-18",
	"checkOutDate": "2025-09-19",
	"status": "pending | paid | refunded | cancelled | rejected",
	"userId": ??
}
```
