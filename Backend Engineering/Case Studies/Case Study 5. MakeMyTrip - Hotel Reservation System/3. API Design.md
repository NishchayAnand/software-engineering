...
Use this endpoint to make a new reservation.
...
    "totalPrice": "7200",
    "currency": "INR",
    "nightlyRates": ["1800","1800","1800","1800"]
}
```

Using `requestId` as an idempotency key allows us to prevent double booking in case the same user clicks on the book button multiple times.
...
```
{
  ...
  "amountCharged": "7200",
  "currency": "INR",
  "createdAt": "2025-09-13T12:01:23Z"
}
```
...
The `ReservationService` intercepts the request and extract all the ...
