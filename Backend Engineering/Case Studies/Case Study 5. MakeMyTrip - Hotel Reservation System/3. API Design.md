...
Enable customers to find hotels by providing a **destination** and **travel dates**. As this is a public-facing API, it should be designed using **RESTful principles**. The key **endpoints** are:
...
public List<HotelSearchResult> searchHotels(destination, checkIn, checkOut):
    ...
    // Step 2: Check availability for the requested booking date range
