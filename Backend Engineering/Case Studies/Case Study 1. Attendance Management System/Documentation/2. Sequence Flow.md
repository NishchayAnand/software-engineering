...
sequenceDiagram
	...
	alt Class already exists
		...
		Note over CS: Generate unique class ID: <br/> "CLASS_0001"
		CS->>CS: classObject = new Class("CLASS_0001", "Mathematics Grade 10", "John Smith")
		CS->>CS: save("CLASS_0001", classObject)
