...
5. Finally, the `Frontend` displays a "Booking Confirmation" page to the `Customer` containing the reservation details along with a unique `booking_reference_number`.
...
sequenceDiagram
    ...
    alt Lock Acquired
	    ...
	    UI-->-C: Ask to Modify Room Types / Quantities
	end
```
