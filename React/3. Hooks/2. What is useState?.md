...
The core functionality of `useState` hook includes: **providing the initial state and an updater function**, **persisting state between component renders**, and **triggering re-renders when the state changes**.
