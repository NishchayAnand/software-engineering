...
- Perfect for DOM access & internal values

---
### Most common reason: Access DOM elements

React is declarative, but sometimes you need **imperative control**.

**Example: focus a textarea**
...
**Example: debounce timer - Store mutable objects (timers, observers)**
...
If you used `useState`, you’d get unnecessary re-renders.
